...
### 3. **Scalability**
- Easy to add new domains without cluttering main file
...
### 4. **Versioning**
- All files should use the same OpenAPI version
...
2. **Create/Update Schemas**: Add schemas to appropriate `schemas/` file
3. **Update Main File**: Ensure references are correct in `main.yaml`
4. **Test**: Validate with Swagger tools
